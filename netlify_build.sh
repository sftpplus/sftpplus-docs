...
mkdir -p deploy/documentation/sftpplus/v/5.10.0/
...
sphinx-build -b html --keep-going -W -D html_theme=integrated -A robots="$DOCS_ROBOT" src/doc_source/ deploy/documentation/sftpplus/v/5.10.0/
