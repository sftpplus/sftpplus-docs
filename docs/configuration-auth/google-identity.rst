...
:From version: 5.26.0
:Description:
    Defines additional certificate authorities trusted for outgoing Google Cloud HTTPS connections.

    The Google certificate authorities distributed with SFTPPlus are always trusted.
...
:From version: 5.14.0
:Description:
    Suffix of the Google ID username to be removed by SFTPPlus when generating the username used for file transfer operations.
