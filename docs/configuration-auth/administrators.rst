...
The Web Manager is a web-based administration interface access-protected through username and password credentials.

During initial installation you are asked to define a username and a corresponding password for the default administration account.

If you forget the username or password of the default administration account,
this section describes how to reset it.
